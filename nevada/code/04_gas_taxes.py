...
nv_excise_df = gas_tax_df[gas_tax_df['state'] == 'Nevada']
nv_excise_df.rename(
    columns = {
        'gas excise tax': 'nv excise tax'
    }, inplace=True
)
nv_excise_df = nv_excise_df[['nv excise tax', 'date']]
...
gas_tax_final_df = pd.merge(gas_tax_final_df, nv_excise_df, on='date', how='outer')
