...
header = {
    'frequency': 'weekly',
    'data': ['value'],
    'facets': {'series': ['EMM_EPM0_PTE_NUS_DPG', 'EMM_EPM0_PTE_SNV_DPG']},
    'start': '2000-01',
    'end': '2025-01',
...
gas_retail_df.rename(
    columns={
        'NEVADA': 'nevada gas (retail) (nominal)',
...
plt.plot(filtered_df.index, filtered_df['nevada gas (retail) (nominal)'], 
