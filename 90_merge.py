...
master_df['national retail excl. ca (nominal)'] = (master_df['national gas (retail) (nominal)'] - (master_df['ca share of usa gas'] * master_df['california gas (retail) (nominal)'])) / (1-master_df['ca share of usa gas'])
...
master_df['average ca local tax'] = 0.01*master_df['california gas (retail) (nominal)']
...
prices = [
    'california gas (retail)', 'national gas (retail)', 'national retail excl. ca',
    'gulf spot price', 'ny spot price', 'la spot price', 'uk brent',
